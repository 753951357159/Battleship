...
PURPOSE:
Creates the Destroyer class that is usable by players.
"""
...
class TraditionalDestroyer(TraditionalVessel):
    """The Destroyer vessel class used for Traditional Battleship."""

    def __init__(self, nation: str, name: str, pennant: int) -> None:
        """
        Initializes a new Destroyer.
    ...
    def __copy__(self) -> TraditionalDestroyer:
        ret = TraditionalDestroyer(self.nation, self.name, self.pennant)
        ret.hp = self.hp
