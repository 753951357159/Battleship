...
PURPOSE:
Creates the Battleship class that is usable by players.
"""
...
class TraditionalBattleship(TraditionalVessel):
    """The Battleship vessel class used for Traditional Battleship."""

    def __init__(self, nation: str, name: str, pennant: int) -> None:
        """
        Initializes a new Battleship.
    ...
    def __copy__(self) -> TraditionalBattleship:
        ret = TraditionalBattleship(self.nation, self.name, self.pennant)
        ret.hp = self.hp
